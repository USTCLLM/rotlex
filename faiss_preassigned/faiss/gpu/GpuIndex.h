...
class GpuIndex : public faiss::Index {
   ...
   protected:
    ...
    virtual void addImpl_(idx_t n, const float* x, const idx_t* ids, const idx_t* assign = nullptr) = 0;
    ...
    void addPaged_(idx_t n, const float* x, const idx_t* ids, const idx_t* assign = nullptr);

    /// Calls addImpl_ for a single page of GPU-resident data
    void addPage_(idx_t n, const float* x, const idx_t* ids, const idx_t* assign = nullptr);
   private:
