...
class GpuIndexIVF : public GpuIndex, public IndexIVFInterface {
   ...
   public:
    ...
    void add_preassigned(idx_t n, const float* x, const idx_t* assign);

    void add_preassigned_with_ids(
            idx_t n,
            const float* x,
            const idx_t* ids,
            const idx_t* assign);
   ...
   protected:
    ...
    void addImpl_(idx_t n, const float* x, const idx_t* ids, const idx_t* assign = nullptr) override;
